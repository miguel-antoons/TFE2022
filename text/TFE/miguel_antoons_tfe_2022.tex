...
\subsection{Contenu du Module}

%? explain file name structure ?
%? explain BRAMS archive directory structure ?
%? explain that it is based on a previous code ?
...
La classe prend sept paramètres en entrée :
...
\begin{itemize}
    ...
    \item Le paramètre \textbf{respect\_date} est un booléen et permet d'optimiser la recherche d'un fichier.
          Une explication détaillée de l'utilité du paramètre est expliqué dans le paragraphe suivant.
          Ce paramètre impose la valeur par défaut 'faux' si l'utilisateur n'indique rien.
...
C'est pourquoi, un outil permettant l'analyse des données a été développé.
