...
Ce logiciel sera implémenté dans un module Python.
Ceci veut dire qu'il pourra facilement être utilisé par d'autres fichiers Python et qu'il est donc très flexible.
