...
\\
Le code de cette méthode peut être visualisé à la figure %! figure.
...
La fonction permettant de calculer le bruit est affichée ce dessous.\\
\\
...
Un bon exemple est l'antenne quatre de la station à Humain entre le 1\textsuperscript{er} mars 2022 et le 30 avril 2022, à la figure %! figure.
...
\\
Un autre exemple est la station à Haacht entre le 1\textsuperscript{er} juillet 2021 et le 31 août 2021 affichée à la figure %! figure n.
...
Une illustration de la convolution peut être trouvée à la figure %!figure.
Afin d'arriver à un bon résultat, il a fallu tester plusieurs filtres.
Le filtre offrant les meilleurs résultats est illustré à la figure %!figure.
