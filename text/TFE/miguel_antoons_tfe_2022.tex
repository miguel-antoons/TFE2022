...
Les données récupérées sont enregistrées toutes les cinq minutes dans des fichiers de format WAV\footnote{Waveform Audio File} avec un taux d'échantillonnage de 5512,5 Hz.
...
\\
Cette station était donc beaucoup plus simple à installer et gérer puisque plus aucun ordinateur externe était nécessaire pour son fonctionnement.
